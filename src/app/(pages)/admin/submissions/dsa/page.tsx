							...
							<tbody>
								...
								{!loading &&
									...
									submissions.map((submission) => (
										...
										>
											<td className="px-4 py-3 text-zinc-100">{submission.id}</td>
											<td className="px-4 py-3 text-zinc-300">
												{submission.submission_id}
											</td>
											<td className="px-4 py-3">
												<p className="text-zinc-100">{submission.name}</p>
												<p className="text-xs text-zinc-500">{submission.user_id}</p>
											</td>
											<td className="px-4 py-3 text-zinc-300">
											...
											<td className="px-4 py-3 text-zinc-400">{submission.token}</td>
